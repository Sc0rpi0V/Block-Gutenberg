...
export default function Inspector(props) {
    ...
    return(
        <InspectorControls>
            <PanelBody title={__('Options du bloc de mise en avant des références', 'Gutenberg-back')} initialOpen={true}>
            <PanelRow>
            ...
            <PanelBody title={__('Style d\'affichage des cartes références', 'Gutenberg-back')} initialOpen={true}>
                 <PanelRow>
                    <ButtonGroup>
                        { ['vertical', 'horizontal'].map( (style) => (
                            <Button
                                isLarge
                                variant={ attributes.refItemsStyle == style ? 'primary' : '' }
                                onClick={ () => setAttributes(
                                    { 
                                        refItemsStyle: style,
                                    } 
